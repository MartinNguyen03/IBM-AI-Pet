...
// GET ALL USERS
app.get('/users', async (req, res) => { //app.get('/user'
  try {
...
// GET COMMS FROM RECIPIENT NAME AND NUMBER
app.post('/comms', async (req, res) => { //app.post('/comms)
  try {
...
// GET COMMS FROM USER ID
app.get('/comms/:userID', async (req, res) => { //app.get(comms)
  try {
...
// POST CALENDAR WITH CONDITION
app.post('/calendar', async (req, res) => { //same endpoint
  try {
...
// DELETE CALENDAR EVENT call userid and eventid
app.delete('/calendar', async (req, res) => { //same endpoint
  try {
...
// GET CALENDAR EVENTS FROM USER ID
app.get('/calendar/:userID', async (req, res) => { //app.get('/calendar')
  try {
